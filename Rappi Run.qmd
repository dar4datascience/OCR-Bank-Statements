...
df_clean_rappy %>% 
  write.csv(
    here::here("outputs", "unified_statements_rappy_202206_a_202304.csv"),
    row.names = FALSE
  )
  
 here::here("outputs", "unified_statements_rappy_202206_a_202304.csv") %>%  googledrive::drive_put(
   #estados de cuenta > unified statements csv
                        "https://drive.google.com/drive/u/0/folders/1WygQuUekXxL5HDdxfmGPfGVmFwCdgork"  ,
                        name = "unified_statements_rappy_202206_a_202304.csv")
```
